...
ActiveRecord::Schema.define(version: 20_190_917_123_448) do
  ...
  create_table 'report_problems', force: :cascade do |t|
    ...
    t.index %w[reportable_type reportable_id], name: 'index_report_problems_on_reportable_type_and_reportable_id'
  ...
  create_table 'services', force: :cascade do |t|
    ...
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
    t.boolean 'start_from', default: false
  ...
  create_table 'views', force: :cascade do |t|
    ...
    t.integer 'viewable_count', default: 1, null: false
    t.index %w[viewable_type viewable_id], name: 'index_views_on_viewable_type_and_viewable_id'
  end
